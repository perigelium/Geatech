...
public class LocationReceiver implements Callback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener
{
    ...
    public LocationReceiver(LocationDataEventListener cb, Context context)
    {
        callback = cb;
