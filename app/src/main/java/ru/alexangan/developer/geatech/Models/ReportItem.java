...
public class ReportItem
{
    ...
    private Gea_immagini_rapporto_sopralluogo gea_immagini_rapporto_sopralluogo;
    ...
    public Gea_immagini_rapporto_sopralluogo getGea_immagini_rapporto_sopralluogo()
    {
        return gea_immagini_rapporto_sopralluogo;
    }

    public void setGea_immagini_rapporto_sopralluogo(Gea_immagini_rapporto_sopralluogo gea_immagini_rapporto_sopralluogo)
    {
